...
import algorithms.tiws_if_replace2_fp.tiws_if_replace2_fp
...
class DetectorThread(threading.Thread):
    ...
    def run(self):
        ...
        elif self.algorithm == "tiws_if_replace2_fp":
            algorithms.tiws_if_replace2_fp.tiws_if_replace2_fp.detect(self.args.datasets, self.args.budget, self.args.runs)

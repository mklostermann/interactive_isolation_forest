...
# Final IIF: TiWS-iForest applied to IAD with replacement of the removed trees AFTER evaluation, with data pruning.
            ...
            for i in range(0, actual_budget):
                ...
                if i == 0:
                    ...
                    if n_replaced_trees > 0:
                        ...
                        new_IF = IsolationForest(n_estimators=n_replaced_trees, max_samples=256).fit(data[pruned_data_indices])

...
# Final IIF: TiWS-iForest applied to IAD with replacement of the removed trees before running TiWS (still after
# evaluation). TiWS is only executed after false positives (trees will be added before).
        ...
        for run in range(1, runs + 1):
            ...
            for i in range(0, actual_budget):
                ...
                if i == 0:
                    ...
                    # Run TiWS only after a false positive
                    if labels[queried_instances[-1]] == 1:
                        ...
                        trained_trees.append(0)

                    active_trees.append(tiws_IF.n_estimators)
